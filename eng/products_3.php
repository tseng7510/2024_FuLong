  ...
  <div class="wrapper insidePages productsList3">
    ...
    <main class="siteMain" aria-label="main" itemscope>
      ...
      <div class="mainBox">
        <section>
          <div class="container">
            <h1 class="unitTitle">Hard Chrome Plated Steel Bar</h1>
            <div class="listBox">
              ...
              <?php for ($i = 0; $i < 3; $i++) { ?>
                <div class="item wow fadeInUp" data-wow-delay="0s">
                  <a href="products_detail.php">
                    ...
                    <div class="info">
                      <h2 class="title">JIS S45C Hard Chrome Plated Steel Bar </h2>
                    </div>
                  </a>
                </div>
              <?php } ?>
      ...
      <div class="breadcrumbBox">
        <div class="container">
          <ul class="breadcrumb" itemscope="" itemtype="https://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope="" itemtype="//schema.org/ListItem">
              <span itemprop="name">Piton Rod</span>
              <meta itemprop="position" content="3">
            </li>
             <li itemprop="itemListElement" itemscope="" itemtype="//schema.org/ListItem">
              <span itemprop="name">Hard Chrome Plated Steel Bar </span>
